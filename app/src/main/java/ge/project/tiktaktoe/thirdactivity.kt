...
class thirdactivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button0.setOnClickListener {
            if (board[0] != "")
                ...
                button0.text = "X"
                board[0] = "X"
                chance = "O"// shans  vadzlevt   0 iks gagrdzelos tamashi
            } else {
                button0.text = "O"
                board[0] = "O"
                chance = "X"
        ...
        buttonReset.setOnClickListener{// gverdis ganaxleba
            startActivity(Intent(this@thirdactivity, thirdactivity::class.java))
        }

        //ukan dabruneba  imageviewze
        ...
        imageViewQuit.setOnClickListener {
            finish()
            moveTaskToBack(true)     //app is shesachereblad
        }
    ...
    private fun result(bd: ArrayList<String>, s: String): Boolean =
        ...
        else if(bd[3] == s && bd[4] == s && bd[5] == s) true//vedzebt shesabamis pozicias
    ...
    // back button  ukan dasabruneblad androidis  mobiles shemtxvevashi
